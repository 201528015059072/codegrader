    ...
    def run_in_subprocess(grading_func)
      begin
        ...
        @pid = fork do
            ...
            puts "*******Before AutoGrader::run_in_subprocess::grading_func.call:******"
            # TODO: the report detail should be found in grading_func.call
            # output_hash e.g: {:raw_score=>0, :raw_max=>100, :comments=>"\n"}
            # output_hash is the final grade of submission
            output_hash = grading_func.call
            puts "There is grade report:\n",  output_hash
            puts "*******AutoGrader::run_in_subprocess:******"
